...
export default function Ajustes() {
  ...
  return (
    <main className="flex h-full flex-col overflow-y-auto bg-purple-50">
      <header className="flex shrink-0 items-center gap-4 p-4">
        <Volver a={rutas.inicio} />
        <h1 className="text-2xl font-bold text-purple-700 sm:text-3xl">{textos.ajustes.titulo}</h1>
      </header>
...
function Bloque({ titulo, children }: { titulo: string; children: ReactNode }) {
  return (
    <section className="flex flex-col gap-3 rounded-3xl bg-white p-5 shadow-md">
      <h2 className="text-lg font-bold text-purple-700">{titulo}</h2>
      {children}
    </section>
  )
}
          ...
          return (
            <button
              ...
              className={`flex-1 rounded-2xl px-4 py-3 text-lg font-bold transition-colors ${
                activo ? 'bg-purple-600 text-white' : 'bg-purple-100 text-purple-700'
              }`}
            >
    ...
    <Bloque titulo={textos.ajustes.volumen}>
      <div className="flex items-center gap-4">
        <input
          ...
          className="h-3 w-full accent-purple-600"
        />
        <span className="w-28 shrink-0 text-right text-base font-bold text-purple-700">
    ...
    return (
      <Bloque titulo={textos.ajustes.reiniciar.titulo}>
        <button
          ...
          className="rounded-2xl bg-purple-100 px-4 py-3 text-lg font-bold text-purple-700"
        >
    ...
    <Bloque titulo={textos.ajustes.reiniciar.titulo}>
      ...
      <div className="flex gap-3">
        ...
        <button
          ...
          className="flex-1 rounded-2xl bg-purple-100 px-4 py-3 text-lg font-bold text-purple-700"
        >
        ...
        <button
          type="button"
          onClick={borrar}
          className="flex-1 rounded-2xl bg-red-500 px-4 py-3 text-lg font-bold text-white"
        >
