...
export function EsquinaDeAjustes() {
  ...
  return (
    <button
      ...
      className="absolute top-4 right-4 z-10 flex size-12 items-center justify-center rounded-full bg-white shadow-[0_4px_0_var(--color-trazo)] transition-transform active:translate-y-1 active:shadow-none"
      {...mantener}
    >
      <Engranaje />
    </button>
